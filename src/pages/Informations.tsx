...
function Cgv() {
  return <Page eyebrow="Abonnement" title="Conditions générales de vente">
    ...
    <Section title="7. Droit de rétractation"><p>Le consommateur dispose en principe de quatorze jours pour exercer son droit de rétractation en écrivant à <ContactLink />. Lorsqu’il demande l’exécution immédiate du service avant la fin de ce délai, les conséquences prévues par la loi, notamment le paiement proportionnel du service déjà fourni le cas échéant, s’appliquent. Les droits légaux du consommateur restent intégralement préservés.</p></Section>
