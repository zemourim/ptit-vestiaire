...
function Faq() {
  const items: Array<[string, ReactNode]> = [
    ...
    ['Qui voit les données de ma famille ?', 'Seuls les comptes membres de la famille peuvent consulter ses vêtements, mouvements et photos. Cette séparation est également imposée par les règles Firebase côté serveur.'],
...
function Confidentialite() {
  return <Page eyebrow="Vos données" title="Politique de confidentialité">
    ...
    <Section title="Sécurité"><p>L’accès nécessite une authentification et une adresse vérifiée. Les règles Firestore et Storage contrôlent côté serveur l’appartenance à la famille. Les photos sont compressées avant transfert et la clé de l’analyse IA reste côté serveur. Aucun dispositif ne pouvant garantir un risque nul, utilisez un mot de passe unique et révoquez rapidement un membre qui ne doit plus accéder à la famille.</p></Section>
